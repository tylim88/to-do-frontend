...
class ListItem extends Component {
    ...
    saveChange = (text, input, toDo, index) => {
        toDo.updateText(text, input, index)
                ...
                >
                    {editMode ? (
                        <Form.Control
                            ...
                            className="list-item"
                            aria-label="modify your item here"
                        />
                    ) : (
                        <>
                            <InputGroup.Prepend>
